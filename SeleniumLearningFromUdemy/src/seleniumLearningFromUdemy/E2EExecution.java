...
public class E2EExecution {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//System.out.println(driver.findElement(By.xpath("//input[contains(@id,'friendsandfamily')]")).isSelected());
		  ...
		  Select select= new Select(driver.findElement(By.cssSelector(".wMed1s.required")));
		...
		driver.findElement(By.xpath("//div[@id='flightSearchContainer']//input[@type='submit']")).click();
